...
public class Ocr extends MyImage {
	...
	public Ocr( MyImage image, Coordinate upperLeft, Coordinate lowerRight ) {
	...
	private final void processing( boolean coordinatesChanged) {
		...
		if ( !this.convertToBlackWhite() && coordinatesChanged ) {
	...
	public char toChar() {
		...
		if ( this.maximaY[0].getValue() == this.getWidth() && this.maximaX[0].getValue() == this.getHeight()
				&& this.maximaX[0].getCoord() > this.getWidth() / 3 && this.maximaX[0].getCoord() < this.getWidth() * 2 / 3) {
		...
		if ( this.getWidth() * 2 > this.getHeight() && this.getHeight() * 2 > this.getWidth()
				&& this.getHistogramY().get(this.getHeight()/2) == this.getWidth() && this.getHistogramX().get(this.getWidth()/2) == this.getHeight() ) {
			return '.' ;
		}
	...
	public static void main( String [] args ) {
		...
		Collection< String > names = Arrays.asList( "0.png", "1.png", "2.png", "3.png", "4.png", "4 black.png", "5.png", "6.png", "7.png",
				"8.png", "9.png", "9 grey small.png", "minus.png", "plus.png", "doppelpunkt.png", "punkt.png", "punkt small.png", "h small.png",
				"grad.png", "C.png" ) ;  
