...
public class Constants {
	...
	/**
	 * Maximum of time, within the screen isn't read again, if no other screen is selected
	 */
	...
	public static final int TIME_ADJUSTMENT_MS_N = 10*60000; // Possible time adjustment of the solvis time every full 10
															// minutes
	public static final int TIME_FINE_ADJUSTMENT_MS_N = 5*60000; // Possible time adjustment of the solvis time every full 10
	// minutes
